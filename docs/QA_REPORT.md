# Informe de calidad — Elite Pen 2.5.2
...
|---|---:|---:|
| Agregar 5.000 trazos | 17,45 ms | 2.500 ms |
| 250 borrados fallidos sobre 5.000 objetos | 20,18 ms | 1.500 ms |
| Limpiar y restaurar 5.000 objetos | 10,17 ms | 2.500 ms |
| Simplificar 100.000 muestras | 115,12 ms | 1.500 ms |
...
- El binario 2.5.2 no esta firmado digitalmente; los hashes del paquete permiten
