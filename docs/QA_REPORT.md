# Informe de calidad — Elite Pen 1.4.0
...
|---|---:|---:|
| Agregar 5.000 trazos | 29,54 ms | 2.500 ms |
| 250 borrados fallidos sobre 5.000 objetos | 31,54 ms | 1.500 ms |
| Limpiar y restaurar 5.000 objetos | 15,01 ms | 2.500 ms |
| Simplificar 100.000 muestras | 169,61 ms | 1.500 ms |
...
- El binario 1.4.0 no esta firmado digitalmente; los hashes del paquete permiten
